...
public interface FacilitiesMasterService {
	...
	public FacilityMasterResponseDataDTO createFacilities(FacilityMasterDTO inspTypeMasterDTO, String userName, Integer integer) throws FacilityMasterException;
